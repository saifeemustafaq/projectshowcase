      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-1">
            ...
            <a
              href="https://github.com/saifeemustafaq/projectshowcase/"
              target="_blank"
              rel="noopener noreferrer"
              className="ml-3 px-4 py-2 rounded-lg font-medium transition-all duration-200 hover:scale-105 border"
              style={{ 
